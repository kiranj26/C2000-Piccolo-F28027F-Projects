 ...
 *
 * Description:
 * This code demonstrates how to use CPU Timer0 to toggle an LED on the Texas Instruments C2000 Piccolo LaunchPad Evaluation Kit (LAUNCHHXL-F28027F).
...
void main(void)
{
    ...
    InitCpuTimer0(); // Initialize Timer0
