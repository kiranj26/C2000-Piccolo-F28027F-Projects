# Timer0 LED Toggle Example

This example demonstrates how to use CPU Timer0 to toggle an LED on the Texas Instruments C2000 Piccolo LaunchPad Evaluation Kit (LAUNCHHXL-F28027F).
...
2. **Create a New Project**:
    ...
    - Enter a project name, e.g., `Timer0_LED_Toggle`.
...
#### InitCpuTimer0
This function configures CPU Timer0 to generate an interrupt every 500 milliseconds.
