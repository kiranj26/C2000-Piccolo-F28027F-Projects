# Timer2 LED Toggle Example

This example demonstrates how to use Timer2 to generate a periodic interrupt on the Texas Instruments C2000 Piccolo LaunchPad Evaluation Kit (LAUNCHHXL-F28027F).
...
2. **Create a New Project**:
    ...
    - Enter a project name, e.g., `Timer2_LED_Toggle`.
...
#### InitCpuTimer2
This function configures Timer2 to generate an interrupt every 500 milliseconds.
