...
This example demonstrates how to use the I2C (Inter-Integrated Circuit) module with interrupts on the Texas Instruments C2000 Piccolo LaunchPad Evaluation Kit (LAUNCHHXL-F28027F).
...
2. **Create a New Project**:
    ...
    - Enter a project name, e.g., `I2C_Interrupt`.
...
5. **Run the Program**:
    - Click the `Run` button to start the program. The I2C module will wait for communication with the master device and handle data using interrupts.

### Code Explanation

#### InitGpio
This function initializes the GPIO settings. GPIO32 is configured as SDAA and GPIO33 as SCLA.

#### InitI2C
This function configures the I2C module with a standard speed of 100 kHz and sets the slave address. It also enables the interrupts for stop condition detection and register access ready.

#### main
The main function initializes the system control, GPIO, and I2C, initializes the PIE control registers and vector table, maps the I2C ISR, and enables the necessary interrupts. It then enters an infinite loop waiting for I2C communication.

#### i2c_isr
The interrupt service routine handles I2C communication. It processes received data or sends data back to the master, and acknowledges the interrupt.
