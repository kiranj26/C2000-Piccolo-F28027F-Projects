 ...
 *
 * Description:
 * This code demonstrates how to use the I2C (Inter-Integrated Circuit) module with interrupts on the Texas Instruments C2000 Piccolo LaunchPad Evaluation Kit (LAUNCHHXL-F28027F).
 * The I2C is configured to communicate at a standard speed of 100 kHz.
 *
 * The code initializes the system control and GPIO settings, configures the I2C module, and handles data transmission and reception in interrupt service routines (ISRs).
 *
 * This example is intended to help users get started with using I2C interrupts for both transmitting and receiving data on the F28027F microcontroller.
 */
